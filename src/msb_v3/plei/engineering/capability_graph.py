...
class SkillBinding:
    ...
    skill_name: str
    provider_ids: tuple[str, ...]  # e.g. ("local.slice", "api.anthropic")
    description: str
...
CAPABILITY_SKILLS: dict[str, list[SkillBinding]] = {
    "mission_definition": [
        SkillBinding("sovereign-project-lifecycle-orchestrator", ("local.slice", "api.anthropic"),
                      "Lifecycle orchestration with mission/architecture reconstruction", "installed"),
    ],
    "problem_analysis": [
        SkillBinding("srse-analyzing-implementations", ("local.slice", "api.anthropic"),
    ...
    "architecture_design": [
        ...
        SkillBinding("agent-designer", ("local.slice", "api.anthropic", "dsh.headless"),
                      "Multi-agent system design with orchestration patterns", "installed"),
        SkillBinding("agent-workflow-designer", ("local.slice", "api.anthropic", "dsh.headless"),
                      "Production-grade multi-agent workflow design", "installed"),
    ],
    "component_decomposition": [
        SkillBinding("interchangeable-components", ("local.slice", "api.anthropic"),
    ...
    "code_review": [
        ...
        SkillBinding("auditing-solo-repos", ("local.slice", "api.anthropic"),
                      "Honest solo-repo evaluation — real craft vs ceremony", "installed"),
    ],
    "testing": [
        SkillBinding("spec-driven-workflow", ("local.slice", "api.anthropic"),
                      "Spec-first development with test generation from specs", "installed"),
        SkillBinding("mutating-skill", ("local.slice",),
                      "Mutation-test verification gates for catch-rate scoring", "installed"),
    ],
    "security_audit": [
        SkillBinding("ship-gate", ("local.slice", "api.anthropic"),
        ...
        SkillBinding("sovereign-verification", ("local.slice", "api.anthropic"),
                      "Sovereign verification ledger and temporal epistemic graph", "installed"),
    ],
    "security_hardening": [
        SkillBinding("sovereign-ghl-infrastructure", ("local.slice", "api.anthropic"),
                      "Compliance, DNS/email, snapshot schemas, AI guardrails", "installed"),
    ],
    "observability": [
        SkillBinding("srse-calibrating-confidence", ("local.slice", "api.anthropic"),
                      "Confidence-level calibration with uncertainty tagging", "installed"),
    ],
    "ci_cd_pipeline": [
        SkillBinding("agent-harness", ("local.slice", "api.anthropic", "dsh.headless"),
    ...
    "research_synthesis": [
        SkillBinding("srse-synthesizing-cross-domain", ("local.slice", "api.anthropic"),
                      "Cross-domain idea synthesis and novelty checking", "installed"),
        SkillBinding("srse-forecasting-scenarios", ("local.slice", "api.anthropic"),
                      "Trend/technology/market forecasting with honest uncertainty", "installed"),
        SkillBinding("notebooklm", ("local.slice",),
                      "NotebookLM — create notebooks, add sources, generate artifacts", "installed"),
    ],
    "automation_development": [
        SkillBinding("n8n-subworkflows", ("local.slice", "api.anthropic"),
                      "Reusable composable n8n sub-workflows", "installed"),
        SkillBinding("n8n-workflow-patterns", ("local.slice", "api.anthropic"),
                      "Proven workflow architectural patterns for n8n", "installed"),
    ],
    "browser_automation": [
        SkillBinding("ego-browser", ("dsh.headless", "local.slice"),
                      "Chromium-based browser for AI agent automation", "installed"),
    ],
    "integration_testing": [
        SkillBinding("n8n-multi-instance", ("local.slice", "api.anthropic"),
                      "Multi-instance n8n testing with instance targeting", "installed"),
        SkillBinding("system-connector", ("local.slice", "api.anthropic"),
                      "Deterministic connector to any third-party system/API", "installed"),
    ],
    "adversarial_testing": [
        SkillBinding("srse-validating-adversarially", ("local.slice", "api.anthropic"),
                      "Adversarial validation — fact-check claims before decisions", "installed"),
        SkillBinding("srse-inverting-assumptions", ("local.slice", "api.anthropic"),
                      "Axiom Inversion Logic — strongest case for the opposite", "installed"),
    ],
    "performance_testing": [
        SkillBinding("srse-designing-experiments", ("local.slice", "api.anthropic"),
    ...
    "capability_planning": [
        ...
        SkillBinding("loop-library", ("local.slice", "api.anthropic"),
                      "Discover, audit, and design repeatable AI-agent loops", "installed"),
    ],
    "roadmap_planning": [
        SkillBinding("srse-forecasting-scenarios", ("local.slice", "api.anthropic"),
                      "Forecast scenarios for roadmap evaluation", "installed"),
        SkillBinding("srse-generating-frameworks", ("local.slice", "api.anthropic"),
    ...
    "mcp_development": [
        SkillBinding("mcp-server-builder", ("local.slice", "api.anthropic"),
                      "Design and ship MCP servers from OpenAPI contracts", "installed"),
    ],
    "process_design": [
        SkillBinding("process-mapper", ("local.slice", "api.anthropic"),
                      "BPMN-style process maps with cycle-time analysis", "installed"),
    ],
    "n8n_expertise": [
        SkillBinding("n8n-binary-and-data", ("local.slice", "api.anthropic"),
                      "Handle files and binary data in n8n correctly", "installed"),
        SkillBinding("n8n-code-javascript", ("local.slice", "api.anthropic"),
                      "JavaScript Code nodes in n8n — patterns and performance", "installed"),
        SkillBinding("n8n-code-python", ("local.slice", "api.anthropic"),
                      "Python Code nodes in n8n", "installed"),
        SkillBinding("n8n-agents", ("local.slice", "api.anthropic"),
                      "Design n8n AI agents — tool calling, memory, RAG, human review", "installed"),
        SkillBinding("n8n-error-handling", ("local.slice", "api.anthropic"),
                      "Wire n8n error handling — retries, Error Trigger, 4xx/5xx", "installed"),
        SkillBinding("n8n-expression-syntax", ("local.slice", "api.anthropic"),
                      "Validate n8n expression syntax and fix common errors", "installed"),
        SkillBinding("n8n-node-configuration", ("local.slice", "api.anthropic"),
                      "Operation-aware node configuration and property dependencies", "installed"),
        SkillBinding("n8n-validation-expert", ("local.slice", "api.anthropic"),
        ...
        SkillBinding("n8n-code-tool", ("local.slice", "api.anthropic"),
                      "Custom Code Tool for n8n AI agents — JS/Python sandbox", "installed"),
        SkillBinding("n8n-mcp-tools-expert", ("local.slice", "api.anthropic"),
