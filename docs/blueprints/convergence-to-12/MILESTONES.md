...
| M6 | Personal Production Trial | 🟡 | ≥30 days usage · measurable value vs baseline · failure burden known · release driven by operating data | [2026-08-17: ledger opened — `operating-ledger-entries.md` seeded with 6 real entries (canonical task, read-only retrieval failure → fixed, unapproved-write denial, kill-switch block, factory dogfood, backup+restore). Real 30-day trial in progress; entries 007+ from daily use.] |
