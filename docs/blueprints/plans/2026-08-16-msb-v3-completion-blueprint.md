...
| 1 | Eliminate architectural debt (version drift, dual vector stores, JSON-file state, module singletons → DI) | 1.1 done · 1.2 done (unified `VectorStore` + backends + parity test + hippocampus endpoints wired) · 1.3/1.4 next |
