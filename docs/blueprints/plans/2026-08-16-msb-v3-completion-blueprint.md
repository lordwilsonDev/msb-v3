...
| 1 | Eliminate architectural debt (version drift, dual vector stores, JSON-file state, module singletons → DI) | 1.1 done · 1.2 core done (unified `VectorStore` + Qdrant/SQLite backends + parity test; endpoint wiring next) |
