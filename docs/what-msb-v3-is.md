...
Python under `src/`: **394 files / 77,193 lines**. Python under `tests/`: **347
files / 61,247 lines**. Markdown under `docs/`: **140 files / 27,920 lines**.
`pytest --collect-only` collects **3,891 tests** (75 deselected by configuration).
