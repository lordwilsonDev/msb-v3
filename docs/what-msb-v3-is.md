...
Python under `src/`: **379 files / 75,059 lines**. Python under `tests/`: **331
files / 58,937 lines**. Markdown under `docs/`: **134 files / 24,788 lines**.
`pytest --collect-only` collects **3,692 tests** (75 deselected by configuration).
