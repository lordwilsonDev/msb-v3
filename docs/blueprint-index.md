...
| `docs/blueprints/2026-09-25-agent-control-plane.md:8` | §11 | `(bare)` | ambiguous | `docs/audits/forensic-build-audit-2026-08-15.md`, `docs/audits/forensic-grill-2026-09-02.md`, `docs/audits/msb-cockpit-audit-schema-v1.md`, … (+12) |
| `docs/blueprints/2026-09-25-agent-control-plane.md:77` | §6 | `(bare)` | ambiguous | `docs/QUICKSTART.md`, `docs/audits/forensic-build-audit-2026-08-15.md`, `docs/audits/forensic-grill-2026-09-02.md`, … (+35) |
| `docs/blueprints/2026-09-25-agent-control-plane.md:98` | §7 | `(bare)` | ambiguous | `docs/audits/forensic-build-audit-2026-08-15.md`, `docs/audits/forensic-grill-2026-09-02.md`, `docs/audits/msb-cockpit-audit-schema-v1.md`, … (+28) |
| `docs/blueprints/2026-09-25-agent-control-plane.md:100` | §9 | `(bare)` | ambiguous | `docs/audits/forensic-build-audit-2026-08-15.md`, `docs/audits/forensic-grill-2026-09-02.md`, `docs/audits/msb-cockpit-audit-schema-v1.md`, … (+20) |
| `docs/blueprints/2026-09-25-agent-control-plane.md:129` | §7 | `(bare)` | ambiguous | `docs/audits/forensic-build-audit-2026-08-15.md`, `docs/audits/forensic-grill-2026-09-02.md`, `docs/audits/msb-cockpit-audit-schema-v1.md`, … (+28) |
| `docs/blueprints/2026-09-25-agent-control-plane.md:158` | §13 | `(bare)` | ambiguous | `docs/audits/forensic-build-audit-2026-08-15.md`, `docs/audits/forensic-grill-2026-09-02.md`, `docs/audits/msb-cockpit-audit-schema-v1.md`, … (+5) |
| `docs/blueprints/2026-09-25-agent-control-plane.md:365` | §2 | `(bare)` | ambiguous | `docs/PRODUCTION-READINESS.md`, `docs/QUICKSTART.md`, `docs/audits/forensic-build-audit-2026-08-15.md`, … (+44) |
| `docs/blueprints/2026-09-25-agent-control-plane.md:373` | §9 | `(bare)` | ambiguous | `docs/audits/forensic-build-audit-2026-08-15.md`, `docs/audits/forensic-grill-2026-09-02.md`, `docs/audits/msb-cockpit-audit-schema-v1.md`, … (+20) |
| `docs/blueprints/2026-09-25-agent-control-plane.md:375` | §11 | `(bare)` | ambiguous | `docs/audits/forensic-build-audit-2026-08-15.md`, `docs/audits/forensic-grill-2026-09-02.md`, `docs/audits/msb-cockpit-audit-schema-v1.md`, … (+12) |
| `docs/blueprints/2026-09-25-agent-control-plane.md:391` | §10 | `(bare)` | ambiguous | `docs/audits/forensic-build-audit-2026-08-15.md`, `docs/audits/forensic-grill-2026-09-02.md`, `docs/audits/msb-cockpit-audit-schema-v1.md`, … (+15) |
| `docs/blueprints/2026-09-25-agent-control-plane.md:393` | §2 | `(bare)` | ambiguous | `docs/PRODUCTION-READINESS.md`, `docs/QUICKSTART.md`, `docs/audits/forensic-build-audit-2026-08-15.md`, … (+44) |
